...
(function (global, factory) {
	...
	(global = global || self, global.dialog = factory(global.Vue));
 ...
 var __vue_script__$2 = script$2;
	...
	var DialogConstructor = Vue.extend(__vue_component__$2);
	var instance;
	var defaultOptions = {
	  title: '',
	  message: '',
	...
	Dialog.confirm = function (options) {
	  return _showDialog(_objectSpread({
	    showLeftBtn: true
	  }, options));
	};
